...
class CLO_Profile extends StatefulWidget {
  @override
  State<CLO_Profile> createState() => _CLO_ProfileState();
}

class _CLO_ProfileState extends State<CLO_Profile> {
  final clo_id = CLO.id;
  String?
            ...
            Padding(
              ...
              child: Custom_Button(
                onPressedFunction: () async {
                  ...
                  if (confirmDelete) {
                    isLoading = true;
                    bool deleted = await CLO.deleteCLO(clo_id);
                    if (deleted) {
                      setState(() {
                        isLoading = false;
                        colorMessage = Colors.green;
                        errorMessage = 'CLO is deleted successfully';
                      });
                      ...
                      setState(() {
                        ...
                        errorMessage = 'Failed to delete CLO';
                      });
                    }
                  }
                },
