...
urlpatterns = [
    ...
    path('users/top',views.AllTopLevelUsers.as_view()),
    ...
    path('group/<int:group_id>/users/university',views.AllUniversityLevelUsers_NotInGroup.as_view()),
    path('group/<int:group_id>/users/campus',views.AllCampusLevelUsers_NotInGroup.as_view()),
    path('group/<int:group_id>/users/department',views.AllDepartmentLevelUsers_NotInGroup.as_view()),
